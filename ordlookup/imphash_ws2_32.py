# DO NOT MODIFY THE ORDINAL MAPPINGS IN THIS FILE

# These are used for calculating imphashes, and changing them will change the imphash values for all files
# that use this module.
# The mapping should match https://github.com/VirusTotal/yara/blob/323356eed/libyara/modules/pe/pe_utils.c
