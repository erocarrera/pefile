# Ordinal-to-name mappings for ws2_32.dll as used for imphash calculation.
# These mappings are frozen to the state prior to the August 2024 change
# so that imphash values remain compatible with other tools (YARA, YARA-X,
# VirusTotal, etc.) that are based on the original pefile implementation.
# Do NOT modify this table; extend ws2_32.py instead.
ord_names = {
    1: b"accept",
    2: b"bind",
    3: b"closesocket",
